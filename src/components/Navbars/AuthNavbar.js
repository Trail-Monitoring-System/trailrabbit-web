            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-blueGray-200 text-blueGray-400 fas fa-sign-in-alt text-lg leading-lg " title="Login" />
                  <span className="lg:hidden inline-block ml-2">Sing In</span>
                </a>
              </li>
